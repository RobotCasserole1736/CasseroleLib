...
public class Xbox360Controller {
     ...
     *@param joystick_id The index to pass to WPIlib for the joystick. Usually 0 is driver1, 1 is driver2, and so on
     */
    ...
    /**
     * @return True if the "Back" button (on top of the controller) is pressed, False if it is not pressed.
     */
    ...
    /**
     * @return True if the "Start" button (on top of the controller) is pressed, False if it is not pressed.
     */
    ...
    /**
     * @return Left stick X axis position. 0 is centered, 1 is all the way to the right, -1 is all the way to the left.
     */
    ...
    /**
     * @return Left stick Y axis position. 0 is centered, 1 is all the way to the top, -1 is all the way to the bottom.
     */
    ...
    /**
     * @return Left trigger depression. 0 is not depressed, 1 is fully pulled in, 0.5 is partially pulled. Note the Xbox underlying 
     * hardware ties the left and right triggers together, so pulling both triggers at the same time results in interesting things
     * happening.
     */
    ...
    /**
     * @return Right trigger depression. 0 is not depressed, 1 is fully pulled in, 0.5 is partially pulled. Note the Xbox underlying 
     * hardware ties the left and right triggers together, so pulling both triggers at the same time results in interesting things
     * happening.
     */
    ...
    /**
     * @return Right stick X axis position. 0 is centered, 1 is all the way to the right, -1 is all the way to the left.
     */
