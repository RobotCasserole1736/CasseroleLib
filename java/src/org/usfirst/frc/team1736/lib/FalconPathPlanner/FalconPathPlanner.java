 ...
 * 
 * FRC 1736 Casserole has made some modifications for documentation and exposing more calibration
 * parameters. Hence the version bump.
 * 
...
public class FalconPathPlanner {
    ...
    /**
     * Array of desired right wheel velocities. Use these to assign setpoints to the PID which
     * controls the speed of the right wheels
     */
    public double[][] smoothRightVelocity;
    /**
     * Array of desired left wheel velocities. Use these to assign setpoints to the PID which
     * controls the speed of the left wheels
     */
    public double[][] smoothLeftVelocity;

    /**
     * Array of expected heading readings (in degrees). Use these to assign setpoints to the
     * controller which adjusts wheel speed based on gyro readings vs. heading error.
     */
    ...
    /**
     * Advanced path adjustment. Experimiental, may cause path non-convergence <br>
     * <br>
     * Path Beta & Alpha determine the allowed divergence from sharp corners in the waypoint set.
     * Lower alpha allows the robot to diverge more from the waypoints given, but causes direction
     * transistions to be more gradual. Tested reasonable range seems to be around 0.1 to 1.0 or so.
     * 
     * @param alpha
     */
     ...
     * <br>
     * Path Beta & Alpha determine the allowed divergence from sharp corners in the waypoint set.
     * Higher beta allows the robot to diverge more from the waypoints given, but causes direction
     * transistions to be more gradual. Tested reasonable range seems to be around 0.01 to 0.6 or
     * so.
     * 
     * @param alpha
     */
    ...
    /**
     * Advanced path adjustment. Experimiental, may cause path non-convergence Totally untested by
     * casserole. Probably does something useful.
     * 
     * @param alpha
     */
     ...
     * Advanced path adjustment. Experimiental, may cause path non-convergence <br>
     * <br>
     * Velocity Beta & Alpha determine the agressivness of acceleration of the drivetrain Lower
     * alpha causes the desired velocity curves to be much smoother and less agressive. Tested
     * reasonable range seemsto be around 0.1 to 0.0001
     * 
     * @param alpha
     */
     ...
     * Advanced path adjustment. Experimiental, may cause path non-convergence <br>
     * <br>
     * Velocity Beta & Alpha determine the agressivness of acceleration of the drivetrain Higher
     * beta causes the desired velocity curves to be much smoother and less agressive. Tested
     * reasonable range seems to be around 0.1 to 0.8 or so.
     * 
     * @param alpha
     */
     ...
     * @param robotTrackWidth - total distance between left and right side wheels of a skid steer
    ...
    public static void main(String[] args) {
        ...
        /*
         * path.setPathBeta(0.1); path.setPathAlpha(0.5); path.setVelocityAlpha(0.01);
