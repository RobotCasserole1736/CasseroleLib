package lib.CasseroleHourmeter;
...
* DESCRIPTION:
* <br>
 * Tracks robot runtime over its life. Records data in a special file on the RIO's filesystem. 
 * Data is useful for determining how long various parts last, or just seeing how much time you've 
 * run your robot for.
 * <br>
* <br>
* USAGE:    
* <ol>   
* <li>Instantiate Class. Hourmeter starts in the background.</li> 
* </ol>
 *
 */
public class CasseroleHourmeter {
	
    /** Location where the hourmeter data will be stored */
	public final String HOURMETER_FNAME = "/home/lvuser/hourmeter/runtime_data.txt";
	
	final int HOURMETER_UPDATE_RATE_MS = 5000;
	
    /** Total minutes the robot has had user software running*/
	public double minutesTotal;
    /** Total minutes the robot has been running in disabled mode.*/
	public double minutesDisabled;
    /** Total minutes the robot has been running in teleop mode.*/
	public double minutesTeleop;
    /** Total minutes the robot has been running in autonomous mode.*/
	public double minutesAutonomous;
    /** Total minutes the robot has been running in test mode.*/
	public double minutesTest;
    /** Number of times the robot has been enabled into teleop mode*/
	public double  numTeleopEnables;
    /** Number of times the robot has been enabled into autonomous mode*/
	public double  numAutonomousEnables;
    /** Number of times the robot has been enabled into test mode*/
	public double  numTestEnables;
	
    /** True when the hourmeter is running, false if it has stopped for any reason */
	public boolean isRunning;
    
    private double prev_call_time_sec;
    private OperationState prev_state; 
