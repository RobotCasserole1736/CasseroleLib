package lib.Logging.methodHandlesCsvLogger;
...
public class CsvLogger {
	...
	/**
	 * Clears the IO buffer in memory and forces things to file. Generally a 
	...
	/**
	 * Determines a unique file name based on current timestamp, and opens a file in the 
     ...
     * there will cause oddly-named log files. Takes no action if log is already open.
